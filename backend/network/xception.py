...
Ported from https://github.com/HongguLiu/Deepfake-Detection
Original XceptionNet: https://arxiv.org/pdf/1610.02357.pdf

Input:  3 x 299 x 299 (RGB, normalized to [0,1], then (x - 0.5) / 0.5)
...
class Xception(nn.Module):
    ...
    def __init__(self, num_classes=2):
        ...
        # last_linear replaces self.fc (matches checkpoint key naming)
